...
<style type="text/css">
	...
	<div class="row">
		...
		<div class="container">
					...
					<h1 style="font-family: century gothic;"st>Multiple Choice</h1>
									...
									@forelse($quizzes as $quiz)
										 ...
										 <tr>
										 	...
										 	<a href="{{route('addmultiple',['id' => $quiz->id])}}" class="btn btn-success btn-xs">Add</a>
										 		...
										 		<!-- <a href="{{route('edit_quiz',['quiz_id'=> $quiz->id])}}" class="btn btn-info btn-xs">Edit</a> -->
										 		<br>
										 		 <a href="{{route('viewmultiple',['id'=> $quiz->id])}}" style="text-decoration: none;margin: 5px;" >View Questions</a>
												...
												<div class="modal-content">
													...
													<div class="modal-footer" style="background-color: rgba(140, 125, 125, 0.42);">
														<a href="{{route('del_quiz',['quiz_id'=> $quiz->id])}}" class="btn btn-danger" >
														<span class="glyphicon glyphicon-trash"></span> Ok</a>
														<a href="{{route('addlesson')}}" class="btn btn-warning" > 
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body" style="background-color: #d8ecd8;">
							<form action="{{route('add_quiz')}}" method="POST">
