	...
	<div class="row">
		...
		<div class="container">
				<div class="panel panel-success" style="margin-top:120px;margin-left: 37px; " >
					...
					<h1 style="font-family: century gothic;">True or False</h1>
							...
							<tbody> 
									...
									@forelse($quizzes as $quiz)
										 ...
										 <tr>
										 	...
										 	<a href="{{route('addfalse',['id' => $quiz->id])}}" class="btn btn-success btn-xs">Add</a>
										 		...
										 		<br>
										 		<a href="{{route('viewtrue',['id'=> $quiz->id])}}" style="text-decoration: none;margin: 5px;" >View Questions</a>
													...
													<div class="modal-dialog">
														...
														<h4>Delete Quiz</h4>
															...
															<div class="modal-footer" style="background-color: rgba(140, 125, 125, 0.42);">
																<a href="{{route('delete_t',['id'=> $quiz->id])}}" class="btn btn-danger" >
																<span class="glyphicon glyphicon-trash"></span> Ok</a>
																<a href="{{route('addt_quests')}}" class="btn btn-warning" > 
